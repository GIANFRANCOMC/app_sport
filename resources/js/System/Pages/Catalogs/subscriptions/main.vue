...
export default {
    ...
    methods: {
        ...
        openModal(record = null) {
            ...
            if(this.isDefined(record)) {
                ...
                Object.keys(this.MODULE.formFields).forEach(key => {
                    ...
                    }else if(key === "duration_type") {

                        entityForms.data.duration_type = this.durationTypes.find(e => e.code === record?.duration_type) || null;
        ...
        prepareFormData(formData) {
            ...
            // Prepare duration_type
            if(prepared.duration_type?.code) {

                prepared.duration_type = prepared.duration_type.code;
