...
<div class="platform-login">
    <div class="platform-card platform-login__card">
        <div class="platform-card__body p-4">
            <div class="mb-4"><div class="platform-brand mb-2"><img class="platform-brand__logo" src="{{ asset('System/assets/img/utils/owner_app/logomark.png') }}" alt="Blapos"><span>Blapos</span></div><h1 class="platform-title">Administración SaaS</h1><p class="platform-subtitle">Gestiona clientes, módulos y comunicaciones.</p></div>
