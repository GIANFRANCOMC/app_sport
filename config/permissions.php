...
return [
    ...
    "route_modules" => [
        ...
        "cash_registers.index" => ["cash_registers.index"],
        ...
        "cash_registers.list" => ["cash_registers.index", "cash_sessions.index", "cash_movements.index", "cash_summary.index"],
        "cash_registers.store" => ["cash_registers.index"],
        "cash_sessions.list" => ["cash_sessions.index"],
        "cash_sessions.open" => ["cash_sessions.index", "cash_registers.index"],
        "cash_sessions.close" => ["cash_sessions.index", "cash_registers.index"],
        "cash_movements.list" => ["cash_movements.index"],
        "cash_movements.store" => ["cash_movements.index"],
        "cash_movements.export" => ["cash_movements.index"],
        "cash_summary.data" => ["cash_summary.index"],
    ],
];
