...
final class RecipeConsumptionService {
    ...
    public static function consume(
        ...
        foreach(($extras["recipe_options"] ?? []) as $selected) {
            ...
            if(!$option) throw new DomainException("Una opción seleccionada no pertenece a la receta.");
        ...
        foreach(($extras["recipe_toppings"] ?? []) as $selected) {
            ...
            if(!$link) throw new DomainException("Un extra seleccionado no pertenece a la receta.");
