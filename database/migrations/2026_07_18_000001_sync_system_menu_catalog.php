...
return new class extends Migration {
    ...
    private const SUB_SECTIONS = [
        ...
        92 => ["section_id" => 9, "slug" => "sc_purchases-new", "name" => "purchases-new", "description" => "Registra una compra nueva con productos, costos, tributos, pagos y recepción.", "order" => 1, "dom_id" => "menu-purchases-new", "dom_label" => "Nuevo", "dom_route" => "purchases.new.index"],
        90 => ["section_id" => 9, "slug" => "sc_purchases-list", "name" => "purchases-list", "description" => "Consulta compras registradas, recepción, estado de pago y trazabilidad.", "order" => 2, "dom_id" => "menu-purchases-list", "dom_label" => "Listado", "dom_route" => "purchases.list.index"],
