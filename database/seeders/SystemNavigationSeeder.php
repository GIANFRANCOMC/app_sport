...
final class SystemNavigationSeeder extends Seeder {
    public function run(): void {
        ...
        $catalog = [
            ...
            "items" => [
                ["id" => 11, "section_id" => 1, "menu_group_id" => null, "order" => 1, "slug" => "sc_workspace", "name" => "workspace", "dom_id" => "menu-workspace", "dom_label" => "Mi espacio", "dom_route" => "workspace.index", "description" => "Retoma tus rutas recientes y accede a las funciones que más utilizas."],
                ["id" => 10, "section_id" => 1, "menu_group_id" => null, "order" => 2, "slug" => "sc_home", "name" => "home", "dom_id" => "menu-home", "dom_label" => "Inicio", "dom_route" => "home.index", "description" => "Organiza y abre tus accesos favoritos del sistema."],
                ["id" => 20, "section_id" => 1, "menu_group_id" => null, "order" => 3, "slug" => "sc_dashboard", "name" => "dashboard", "dom_id" => "menu-dashboard", "dom_label" => "Dashboard", "dom_route" => "dashboard.index", "description" => "Consulta indicadores y el estado general de la operación."],
                ...
                ["id" => 80, "section_id" => 1, "menu_group_id" => null, "order" => 4, "slug" => "sc_reports", "name" => "reports", "dom_id" => "menu-reports", "dom_label" => "Reportes", "dom_route" => "reports.index", "description" => "Genera reportes para análisis operativo."],
            ],
        ];
