...
final class SystemNavigationSeeder extends Seeder {
    public function run(): void {
        ...
        $catalog = [
            ...
            "sections" => [
                ["id" => 1, "menu_category_id" => 1, "slug" => "sc_home", "name" => "home", "order" => 1, "dom_id" => "menu-parent-home", "dom_label" => "Inicio", "dom_icon" => "fa fa-home", "has_sub_menu" => false],
                ["id" => 2, "menu_category_id" => 1, "slug" => "sc_dashboard", "name" => "dashboard", "order" => 2, "dom_id" => "menu-parent-dashboard", "dom_label" => "Dashboard", "dom_icon" => "fa-solid fa-gauge", "has_sub_menu" => false],
                ["id" => 8, "menu_category_id" => 1, "slug" => "sc_reports", "name" => "reports", "order" => 3, "dom_id" => "menu-parent-reports", "dom_label" => "Reportes", "dom_icon" => "fa fa-chart-column", "has_sub_menu" => false],
                ...
                ["id" => 15, "menu_category_id" => 2, "slug" => "sc_customer_attention", "name" => "customer-attention", "order" => 4, "dom_id" => "menu-parent-customer-attention", "dom_label" => "Atención al cliente", "dom_icon" => "fa-solid fa-headset", "has_sub_menu" => true],
                ...
                ["id" => 12, "menu_category_id" => 3, "slug" => "sc_staff", "name" => "staff", "order" => 4, "dom_id" => "menu-parent-staff", "dom_label" => "Colaboradores", "dom_icon" => "fa-solid fa-users-gear", "has_sub_menu" => true],
                ["id" => 6, "menu_category_id" => 4, "slug" => "sc_infrastructure", "name" => "infrastructure", "order" => 1, "dom_id" => "menu-parent-infrastructure", "dom_label" => "Organización", "dom_icon" => "fa-solid fa-building", "has_sub_menu" => true],
            ...
            "groups" => [
                ...
                ["id" => 6, "section_id" => 9, "code" => "suppliers", "label" => "Proveedores", "order" => 2],
                ...
                ["id" => 9, "section_id" => 15, "code" => "services", "label" => "Servicios", "order" => 1],
                ["id" => 10, "section_id" => 15, "code" => "communications", "label" => "Comunicaciones", "order" => 2],
                ...
                ["id" => 17, "section_id" => 12, "code" => "team", "label" => "Equipo", "order" => 1],
                ["id" => 18, "section_id" => 6, "code" => "locations", "label" => "Sedes", "order" => 1],
                ["id" => 19, "section_id" => 6, "code" => "assets", "label" => "Activos", "order" => 2],
                ["id" => 20, "section_id" => 7, "code" => "company", "label" => "Empresa", "order" => 1],
                ["id" => 21, "section_id" => 7, "code" => "access", "label" => "Accesos", "order" => 2],
                ["id" => 22, "section_id" => 7, "code" => "master_data", "label" => "Datos maestros", "order" => 3],
            ],
            "items" => [
                ["id" => 10, "section_id" => 1, "menu_group_id" => null, "order" => 1, "slug" => "sc_home", "name" => "home", "dom_id" => "menu-home", "dom_label" => "Inicio", "dom_route" => "home.index", "description" => "Organiza y abre tus accesos favoritos del sistema."],
                ["id" => 20, "section_id" => 2, "menu_group_id" => null, "order" => 1, "slug" => "sc_dashboard", "name" => "dashboard", "dom_id" => "menu-dashboard", "dom_label" => "Dashboard", "dom_route" => "dashboard.index", "description" => "Consulta indicadores y el estado general de la operación."],
                ...
                ["id" => 100, "section_id" => 10, "menu_group_id" => 7, "order" => 1, "slug" => "sc_cash-registers", "name" => "cash-registers", "dom_id" => "menu-cash-registers", "dom_label" => "Cajas", "dom_route" => "cash_registers.registers.index", "description" => "Gestiona las cajas configuradas por sucursal."],
                ["id" => 101, "section_id" => 10, "menu_group_id" => 7, "order" => 2, "slug" => "sc_cash-sessions", "name" => "cash-sessions", "dom_id" => "menu-cash-sessions", "dom_label" => "Aperturas y cierres", "dom_route" => "cash_registers.sessions.index", "description" => "Consulta aperturas, cierres, arqueos y diferencias."],
                ["id" => 102, "section_id" => 10, "menu_group_id" => 7, "order" => 3, "slug" => "sc_cash-movements", "name" => "cash-movements", "dom_id" => "menu-cash-movements", "dom_label" => "Movimientos", "dom_route" => "cash_registers.movements.index", "description" => "Registra entradas, salidas y ajustes de dinero."],
                ["id" => 103, "section_id" => 10, "menu_group_id" => 8, "order" => 1, "slug" => "sc_cash-summary", "name" => "cash-summary", "dom_id" => "menu-cash-summary", "dom_label" => "Resumen de caja", "dom_route" => "cash_registers.summary.index", "description" => "Revisa importes esperados, contados y diferencias."],
                ...
                ["id" => 106, "section_id" => 15, "menu_group_id" => 9, "order" => 1, "slug" => "sc_service-sessions", "name" => "service-sessions", "dom_id" => "menu-service-sessions", "dom_label" => "Servicios en curso", "dom_route" => "service_sessions.index", "description" => "Inicia, asigna y finaliza servicios."],
                ["id" => 44, "section_id" => 15, "menu_group_id" => 10, "order" => 1, "slug" => "sc_customers-notifications", "name" => "customers-notifications", "dom_id" => "menu-customers-notifications", "dom_label" => "Notificaciones", "dom_route" => "tracking_notifications.index", "description" => "Gestiona comunicaciones y avisos para clientes."],
                ["id" => 45, "section_id" => 15, "menu_group_id" => 10, "order" => 2, "slug" => "sc_customers-book_complaints", "name" => "customers-book-complaints", "dom_id" => "menu-customers-book-complaints", "dom_label" => "Libro de reclamaciones", "dom_route" => "book_complaints.index", "description" => "Atiende reclamos, quejas y sugerencias."],
                ...
                ["id" => 71, "section_id" => 12, "menu_group_id" => 17, "order" => 1, "slug" => "sc_configuration-users", "name" => "configuration-users", "dom_id" => "menu-configuration-users", "dom_label" => "Colaboradores", "dom_route" => "users.index", "description" => "Administra colaboradores internos."],
                ["id" => 104, "section_id" => 12, "menu_group_id" => 17, "order" => 2, "slug" => "sc_user-attendances", "name" => "user-attendances", "dom_id" => "menu-user-attendances", "dom_label" => "Asistencia del personal", "dom_route" => "user_attendances.index", "description" => "Controla ingresos, salidas y horas trabajadas."],
                ...
                ["id" => 70, "section_id" => 7, "menu_group_id" => 20, "order" => 1, "slug" => "sc_configuration-my-company", "name" => "configuration-my-company", "dom_id" => "menu-configuration-my-company", "dom_label" => "Mi empresa", "dom_route" => "companies.index", "description" => "Actualiza la identidad y datos de la empresa."],
                ...
                ["id" => 80, "section_id" => 8, "menu_group_id" => null, "order" => 1, "slug" => "sc_reports", "name" => "reports", "dom_id" => "menu-reports", "dom_label" => "Reportes", "dom_route" => "reports.index", "description" => "Genera reportes para análisis operativo."],
            ],
        ];
