...
class CommercialCatalogSeeder extends Seeder {
    ...
    private function items(array $brands): array {
        ...
        $products = [
            ...
            ["code" => "WHEY1KG", "name" => "Proteina whey 1 kg", "description" => "Suplemento demo de alta rotacion.", "price" => 145.00, "min" => 130.00, "max" => 170.00, "brand" => "Gympe", "categories" => ["Suplementos"], "quantity" => 10, "minimum" => 3, "cost" => 95.00],
            ["code" => "WHEYCH2", "name" => "Proteina whey chocolate 2 lb", "description" => "Proteina sabor chocolate para venta recurrente.", "price" => 118.00, "min" => 105.00, "max" => 145.00, "brand" => "Gympe", "categories" => ["Suplementos"], "quantity" => 12, "minimum" => 4, "cost" => 78.00],
            ["code" => "CREA300", "name" => "Creatina monohidratada 300 g", "description" => "Suplemento basico para fuerza y rendimiento.", "price" => 95.00, "min" => 84.00, "max" => 120.00, "brand" => "Gympe", "categories" => ["Suplementos"], "quantity" => 14, "minimum" => 4, "cost" => 62.00],
            ...
            ["code" => "BARVAI", "name" => "Barra proteica vainilla", "description" => "Snack practico para mostrador.", "price" => 8.00, "min" => 7.00, "max" => 10.00, "brand" => "Gympe", "categories" => ["Suplementos"], "quantity" => 30, "minimum" => 10, "cost" => 4.80],
            ["code" => "BARCHO", "name" => "Barra proteica chocolate", "description" => "Snack proteico sabor chocolate.", "price" => 8.50, "min" => 7.50, "max" => 10.50, "brand" => "Gympe", "categories" => ["Suplementos"], "quantity" => 26, "minimum" => 10, "cost" => 5.10],
            ...
            ["code" => "SHAKER", "name" => "Shaker 700 ml", "description" => "Vaso mezclador para suplementos.", "price" => 22.00, "min" => 18.00, "max" => 30.00, "brand" => "Gympe", "categories" => ["Accesorios"], "quantity" => 18, "minimum" => 5, "cost" => 12.00],
            ...
            ["code" => "GUANTE", "name" => "Guantes de entrenamiento", "description" => "Guantes para pesas y barras.", "price" => 39.00, "min" => 34.00, "max" => 55.00, "brand" => "Gympe", "categories" => ["Accesorios"], "quantity" => 16, "minimum" => 4, "cost" => 23.00],
            ["code" => "VENMUN", "name" => "Vendas de muneca", "description" => "Soporte para levantamiento y entrenamiento.", "price" => 28.00, "min" => 24.00, "max" => 38.00, "brand" => "Gympe", "categories" => ["Accesorios"], "quantity" => 13, "minimum" => 4, "cost" => 16.00],
            ["code" => "CUERDA", "name" => "Cuerda de salto", "description" => "Accesorio para cardio y calentamiento.", "price" => 32.00, "min" => 28.00, "max" => 45.00, "brand" => "Gympe", "categories" => ["Accesorios"], "quantity" => 11, "minimum" => 3, "cost" => 18.00],
            ...
            ["code" => "CANDADO", "name" => "Candado para locker", "description" => "Candado pequeno para casilleros.", "price" => 15.00, "min" => 12.00, "max" => 22.00, "brand" => "Gympe", "categories" => ["Accesorios"], "quantity" => 12, "minimum" => 4, "cost" => 7.20],
            ["code" => "GRIPBAR", "name" => "Grip para barra", "description" => "Agarre de soporte para entrenamiento con barra.", "price" => 34.00, "min" => 30.00, "max" => 48.00, "brand" => "Gympe", "categories" => ["Accesorios"], "quantity" => 10, "minimum" => 3, "cost" => 20.00],
            ...
            ["code" => "MAGLIQ", "name" => "Magnesio liquido", "description" => "Magnesio para agarre en ejercicios de fuerza.", "price" => 31.00, "min" => 27.00, "max" => 42.00, "brand" => "Gympe", "categories" => ["Accesorios"], "quantity" => 14, "minimum" => 4, "cost" => 18.00],
